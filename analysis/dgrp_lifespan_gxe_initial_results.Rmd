---
title: "Prediction of lifespan with different models"
...
has life span measurements for 176 lines at 3 temperatures (18C, 25C, 28C) for the 2 sexes. In this work, we used both temperature 
and sex as environmental variables.
...
$\mu$ is an $q$-vector of intercept values, 
...
These models were fitted using a Bayesian approach as implemented in the $\sf BGLR$ package.

We used different cross-validation schemes:

* We assigned 20\% of the *observations* (i.e., combination of line, sex and temperature) to the test set randomly. This
procedure was repeated 20 times.
* We assigned 20\% of the *lines* (i.e., for the 2 sexes and the 3 temperatures) to the test set randomly. This
procedure was repeated 20 times.

Prediction accuracy was evaluated as the correlation coefficient between observed and predicted phenotypes.
