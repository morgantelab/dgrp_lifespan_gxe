...
* Scale it across sex/temperature combinations.
...
#### Phenotype scaled across environments

```{r random within env scaled overall, fig.height=10, fig.width=13}
sex <- c(1, 0)
temp <- c(18,25,28)
model <- "G"
pheno <- "scaled_overall_pheno"
...
```{r random lines overall, fig.height=10, fig.width=13}
schemes <- "random_lines"
model <- c("G", "E", "GandE", "GxE")
pheno <- "scaled_overall_pheno"
...
With the phenotype on the original scale or scaled across the environments, the results show that G-BLUP performs poorly. 
...
```{r random obs overall, fig.height=10, fig.width=13}
schemes <- "random_obs"
model <- c("G", "E", "GandE", "GxE")
pheno <- "scaled_overall_pheno"
...
With the phenotype on the original scale or scaled across the environments, the results show that, as expected, GE-BLUP improves 
...
```{r across overall, fig.height=10, fig.width=13}
n_reps <- 3
schemes <- "temp"
model <- c("G", "E", "GandE", "GxE")
pheno <- "scaled_overall_pheno"
...
With the phenotype on the original scale or scaled across the environments, in general, prediction accuracy is lower in this scenario. 
